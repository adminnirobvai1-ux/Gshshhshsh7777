...
                f"উইনগো ৩০এস অটোমেশন বটের প্রিমিয়াম প্ল্যান তালিকা:\n\n"
                f"1 Day: 500 BDT\n"
                f"3 Days: 1,300 BDT\n"
                f"6 Days: 2,400 BDT\n"
                f"7 Days: 2,700 BDT\n"
...
                f"প্রদেয় পরিমাণ: <b>{kwargs.get('price', 0)} BDT</b>\n\n"
                f"দয়া করে আপনার সুবিধাজনক পেমেন্ট মেথডটি নির্বাচন করুন:"
            ),
...
                f"দয়া করে নিচের নম্বরে সেন্ড মানি করুন:\n"
...
                f"আপনার পেমেন্ট রিকোয়েস্টটি যাচাইকরণের জন্য মালিকের নিকট পাঠানো হয়েছে।\n"
                f"অনুগ্রহ করে অল্প কিছুক্ষণ অপেক্ষা করুন।"
            ),
            "approved_user": (
                f"<b>{to_bold('PAYMENT APPROVED')}</b>\n\n"
                f"আসসালামু আলাইকুম। প্রিয় গ্রাহক আপনার লেনদেনটি সফল হয়েছে।\n"
                f"আপনার সাবস্ক্রিপশন সফলভাবে সক্রিয় করা হয়েছে।\n\n"
